...
# ╔═╡ 28e5e2d7-4390-4764-93d0-e6047bb6b62b
using PlutoUI, CairoMakie, DataFrames, GLM, StatsBase

# ╔═╡ 16ed5ee2-2de1-11ed-1818-cf8f3be1ddc4
md"# Chemistry 254 - Experiment 2"

# ╔═╡ b4bd6d19-d35c-4f93-aaa1-3962325f0ce6
md"## Packages and data"

# ╔═╡ e951f972-25ac-4496-ae08-f8e900566efc
m_char = [0, 0, 2.2191, 2.1524, 2.243, 2.0128, 2.0998, 2.0209, 2.031];

# ╔═╡ 29a8d341-ee4a-476d-aa40-96329dbc0226
M_char = 12.011;

# ╔═╡ 511ad4d9-1495-4ed4-a960-dd907bbecb06
M_acet = 60.052;

# ╔═╡ e1894aa0-cc9b-46e4-87e9-264669b1bf90
c_acet = 0.4946;

# ╔═╡ 94877914-bd1b-4a95-824d-cfa651452e8e
v_acet = [0, 0, 100, 50, 36, 25, 18, 10, 5] ./ 1000

# ╔═╡ ae48fe06-e545-45bd-9fe4-8f5eb9d98f32
n_acet = c_acet * v_acet

# ╔═╡ 15e3681b-797f-4d97-96ac-31fdff480f3b
vt_acet = [50, 50 ,10, 10, 10, 25, 25, 50, 50] ./ 1000

# ╔═╡ 39c7b775-61d2-4b46-a2ed-20d97925dbbd
ct_acet = c_acet * v_acet / 0.1

# ╔═╡ 99aaead1-4a30-4407-829f-5508eb34f164
m_acet = c_acet * v_acet / M_acet

# ╔═╡ f17b98f8-389c-46de-ac47-29fe3b7bec16
c_NaOH = 0.2001;

# ╔═╡ e1148f46-2bad-4e32-91ab-1b79c3c9a822
v_NaOH = [0.5, 0.6, mean([22.5, 19.1]), mean([12.3, 12,31]), mean([7.94, 7.98]), mean([13.7, 14]), mean([10.3, 10.12]), 13.1, 5.56] ./ 1000
...
df1 = DataFrame((X = (log.(eqc_acet)), Y = (log.(Δm_acet./m_char[3:end]))));
...
begin
	...
	ax1 = Axis(f1[1, 1],
		xlabel = L"\log (c)", 
		ylabel = L"\log \left( \frac{x}{m} \right)"
		)
	x1 = log.(eqc_acet)
